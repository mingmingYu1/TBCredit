...
import javax.persistence.Table;
 /**
 * 法人代表失信曝光台
 * @version 2016-6-22 10:35:09 ${user}
 */
  @Entity
  @Table(name="ods_agent_top_leader_court_exposure", catalog="credit_db")
  public class AgentTopleaderCourExposureEntity implements Serializable{
  
       
	private static final long serialVersionUID = -3923447451298835439L;


	public AgentTopleaderCourExposureEntity(){
