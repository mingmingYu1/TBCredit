 ...
 */
@Entity
@Table(name = "ods_agent_tax_account_info", catalog = "credit_db")
public class AgentTaxAccountEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AgentTaxAccountEntity other = (AgentTaxAccountEntity) obj;
		if (id == null) {
			if (other.id != null)
				return false;
