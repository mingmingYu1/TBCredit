...
@Entity
@Table(name ="ods_report_templet", catalog="credit_db")
public class ReportTempletEntity implements Serializable{

	private static final long serialVersionUID = 5771779230901997888L;
