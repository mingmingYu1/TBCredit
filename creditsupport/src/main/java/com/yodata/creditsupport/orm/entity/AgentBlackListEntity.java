 ...
 */
@Entity
@Table(name = "ods_agent_black_list", catalog = "credit_db")
public class AgentBlackListEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AgentBlackListEntity other = (AgentBlackListEntity) obj;
		if (id == null) {
			if (other.id != null)
				return false;
