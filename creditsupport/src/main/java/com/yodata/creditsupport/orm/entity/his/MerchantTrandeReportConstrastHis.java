...
@Entity
@Table(name = "ods_merchant_trade_report_constrast_info_his", catalog = "credit_db")
public class MerchantTrandeReportConstrastHis implements Serializable{

	private static final long serialVersionUID = 2350386387275081032L;
	...
	// =============== 自增主键 =================
		...
		private Date createTime;		// 生成时间
		 ...
		 public MerchantTrandeReportConstrastHis() {
				// TODO Auto-generated constructor stub
			}
			
		   public MerchantTrandeReportConstrastHis(String fileNo,Date createTime) {
				// TODO Auto-generated constructor stub
			   this.fileNo = fileNo;
