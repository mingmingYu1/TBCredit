...
<div id="system" class="container-fluid" style="min-width:1000px;min-height:400px;">
	<div class="row">
		<div class="col-xs-2" id="leftNav">
			<ul class="leftNav">
				<mrp:p rId="42">
					<li><a href="${pageContext.request.contextPath}/jsp/dept-manage.jsp">部门管理</a></li>
				</mrp:p>
				<mrp:p rId="43">
					<li><a href="${pageContext.request.contextPath}/jsp/role-manage.jsp">角色管理 </a></li>   <!--<span class="newSpan">NEW</span>-->
				</mrp:p>
				<mrp:p rId="41">
					<li><a href="${pageContext.request.contextPath}/jsp/user-manage.jsp">用户管理</a></li><!--<span class="hotSpan">HOT</span>-->
				</mrp:p>
			</ul>
		</div>
		<div class="col-xs-10">
...
if(leftAs.length > 0) {
	...
	$system.css("height",docHeight);
	$system.html('<div class="noPermissions">您无权限访问此页面!</div>')
}
