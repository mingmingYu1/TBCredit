...
<div class="container-fluid" style="min-width:1100px;min-height:400px;">
	<div class="row">
		<div class="col-xs-2" id="leftNav">
			<ul class="leftNav">
				<mrp:p rId="31">
					<li class="active"><a href="${pageContext.request.contextPath}/jsp/person/indicator-manage.jsp">指标体系管理</a></li>
				</mrp:p>
				<mrp:p rId="32">
					<li><a href="${pageContext.request.contextPath}/jsp/person/scoreLevelVersion-manage.jsp">评分版本管理</a></li>
				</mrp:p>
				<mrp:p rId="33">
					<li><a href="${pageContext.request.contextPath}/jsp/person/scoreModel-manage.jsp">评分模型管理</a></li> 
				</mrp:p> 
				<mrp:p rId="34">
					<li ><a href="${pageContext.request.contextPath}/jsp/person/person-creditReport-model.jsp">征信报告模板</a></li><!--<span class="hotSpan">HOT</span>-->
				</mrp:p>
			</ul>
		</div>
...
$('#header').load("${pageContext.request.contextPath}/jsp/person/personHeader.jsp?time="+new Date().getTime(), {name: '22'}, function(){
