...
@Entity
@Table(name ="ods_person_invest_punishbreak_report", catalog="credit_db")
public class OdsPersonInvestPunishbreakReportEntity implements Serializable {
	...
	// ============执行文号 =================
	private String executeDocumentnumber;
	...
	public OdsPersonInvestPunishbreakReportEntity(){};
	public OdsPersonInvestPunishbreakReportEntity(String fileNo, Date createTime) {
		this.fileNo = fileNo;
	...
	// ============执行文号 =================
	@Column(name="execute_documentnumber")
	public String getExecuteDocumentnumber()
	{
		return this.executeDocumentnumber;
	};
...
@Override
	public String toString(){
		 return "id=" + id
			 ...
			 + ", executeCourt=" + executeCourt
			 + ", province=" + province
			 + ", executeDocumentnumber=" + executeDocumentnumber
			 + ", gistunit=" + gistunit
			 + ", duty=" + duty
