...
import javax.persistence.Table;
 /**
 * 法定代表人失信网贷黑名单
 * @version 2016-6-22 10:00:04 ${user}
 */
  @Entity
  @Table(name="ods_agent_top_leader_net_loan_violate",catalog="credit_db")
  public class AgentTopleaderNetloanEntity implements Serializable{
  
       private static final long serialVersionUID = 1L;
       
       public AgentTopleaderNetloanEntity(){
