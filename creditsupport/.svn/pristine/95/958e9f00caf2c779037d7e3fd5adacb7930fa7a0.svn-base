...
import javax.persistence.Table;
 /**
  *阿里欠贷
 * @version 2016-6-22 11:00:43 ${Jason}
 */
  @Entity
  @Table(name="ods_agent_ali_loan_break" ,catalog="credit_db")
  public class AgentAliLoanbreakEntity implements Serializable{

   private static final long serialVersionUID = 5460224488169479160L;

	public AgentAliLoanbreakEntity(){}
