...
@Entity
@Table(name ="ods_person_risk_shixin_report", catalog="credit_db")
public class OdsPersonRiskShixinReportEntity implements Serializable {
	...
	public OdsPersonRiskShixinReportEntity(){}
	
	public OdsPersonRiskShixinReportEntity(String fileNo, Date createTime)
	{
		this.fileNo = fileNo;
