...
@Entity
@Table(name ="ods_person_risk_wdhmd_report", catalog="credit_db")
public class OdsPersonRiskWdhmdReportEntity implements Serializable {
	...
	public OdsPersonRiskWdhmdReportEntity(){}
	
	public OdsPersonRiskWdhmdReportEntity(String fileNo, Date createTime)
	{
		this.fileNo = fileNo;
