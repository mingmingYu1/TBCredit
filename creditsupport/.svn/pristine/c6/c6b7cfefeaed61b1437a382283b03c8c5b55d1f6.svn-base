		...
		<div class="tableContainer">
			<div>
				<table id="cimc_dept" data-toggle="table" data-cache="false" data-pagination="true" data-side-pagination="server"
							 data-url="/creditsupport/personDept/query" class="table table-striped">
					<thead>
					<tr>
	...
	<div class="modal-dialog" style="width: 660px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form" id="dept_form" action="/creditsupport/personDept/adddept" method="post">
					...
					<div class="modalInput">
						<div>
							<label for="add_dept_pid">上级部门：</label>
						</div>
						<div>
							<div>
...
<div class="modal fade" id="deptEditModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width: 660px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form" id="edit_dept_form" action="/creditsupport/personDept/updateDept" method="post">
					<div class="modalInput">
...
function operateFormatterDept(value, row, index) {
	return [
	    '<a href="javascript:void(0)"  class="_edit" title="编辑">编辑</a>&nbsp&nbsp',
	    '<a href="javascript:void(0)" class="_remove" title="删除">删除</a>'
	].join('');
}
	...
	'click ._remove': function (e, value, row, index) {
		...
		var option = {
			...
			onOk: function(){
					...
					$.ajax({ 
						url: "/creditsupport/personDept/deldept", 
						type:"post",
						dataType:"json",
						cache:"false",
						data:params, 
...
//   编辑部门方法
function edit_dept() {
	$("#edit_dept_form").ajaxSubmit(function (result) {
...
function add_deptname(){
	$("#dept_form").ajaxSubmit(function (result) {
...
function finddept(){
	...
	$.ajax({ 
		url: "/creditsupport/personDept/query", 
		type:"post",
		dataType:"json",
		cache:"false",
		data:params, 
